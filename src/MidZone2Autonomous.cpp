...
#define bumpSafety 1.5
#define bumpSafetyTwo 1.0
#define iterationCount 2

MidZone2Autonomous::MidZone2Autonomous() :
	pilot(), manip() {
...
void MidZone2Autonomous::Periodic() {
}

void MidZone2Autonomous::Continuous() {
